...
public class MainActivity extends AppCompatActivity
    ...
    public static String [] prgmNameList={"Let Us C","jitu","electric","gitu","Microsoft .Net","Android","PHP","Jquery","JavaScript","JavaScript","JavaScript","JavaScript","JavaScript","JavaScript","JavaScript","JavaScript"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        area_name = (EditText) findViewById(R.id.editTextId1);
       /* service_name = (EditText) findViewById(R.id.editTextId2);*/
